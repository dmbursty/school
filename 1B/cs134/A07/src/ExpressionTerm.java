public class ExpressionTerm implements ExpressionTreeInterface {
  public int term;
  
  public ExpressionTerm(int term) {
    this.term = term;
  }
  ...
  public ExpressionTreeInterface factorBy(int n)
  {
    if (term%n == 0 && term != n)
    {
      return DataFactory.makeExpressionTree(DataFactory.makeExpressionTree(term/n), '*', DataFactory.makeExpressionTree(n)).factorBy(n);
    }
    else
    {
      return this;
