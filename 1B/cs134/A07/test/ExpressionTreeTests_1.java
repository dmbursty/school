...
public class ExpressionTreeTests_1 extends TestCase {
  
  // Creates an expression of a single term
  public ExpressionTreeInterface makeTerm()
  {
    return DataFactory.makeExpressionTreeBonus(12);
  }
  
  // Creates an expression
  public ExpressionTreeInterface makeExpression()
  {
    return DataFactory.makeExpressionTreeBonus(DataFactory.makeExpressionTreeBonus(DataFactory.makeExpressionTreeBonus(3), '*', DataFactory.makeExpressionTreeBonus(2)), '+', DataFactory.makeExpressionTreeBonus(5));
  }
